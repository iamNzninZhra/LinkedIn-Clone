        ...
        <Container>
          <ShareBox>
            ...
            <div>
              ...
              <button>
                <img src="/images/article-icon.png" alt="Write article" />
                <span>Write article</span>
              </button>
            </div>
          </ShareBox>
          <Content>
            {props.loading && <img src="./images/loading-icon.png" alt="Loading" />}
                ...
                <SocialCounts>
                  <li>
                    <button>
                      ...
                      <img src="/images/clapping-hands-icon.png" alt="Clap" />
                      <span>75</span>
                    </button>
                  </li>
                  <li>
