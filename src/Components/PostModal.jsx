...
const PostModal = (props) => {
    ...
    const handleChange = (e) => {
        ...
        if (image === '' || image === undefined) {
            alert('no images ,the file is a ${typeof image}')
            return;
        }
        setShareImage(image)
    }
            ...
            {props.showModal === 'open' && (
                <Container>
                    <Content>
                        <Header>
                            <h2>Create a post</h2>
                            <button onClick={(event) => reset(event)}><img src="/images/close-icon.png" /></button>
                        </Header>
                        <SharedContent>
                            <UserInfo>
...
color: ${(props) => (props.disabled ? 'rgba(1,1,0.2)' : 'white')};
